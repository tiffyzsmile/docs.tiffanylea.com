...
export default {
  ...
  "baseUrl": "/",
  "organizationName": "tiffyzsmile",
  "projectName": "docs.tiffanylea.com",
  "onBrokenLinks": "throw",
  ...
  "presets": [
    [
      "classic",
      {
        ...
        "theme": {
          "customCss": "/Users/tiffany/Sites/TiffanyLea/docs.tiffanylea.com/src/css/custom.css"
        }
      }
    ]
  ],
  "themeConfig": {
    ...
    "footer": {
      ...
      "copyright": "Copyright © 2023 Tiffany Lea"
    },
    "prism": {
      "theme": {
        "plain": {
